...
const en = {
  ...
  paletteGroupPipeline: "Pipeline",
  paletteGroupProject: "Project",
  ...
  navCleanup: "Cleanup",
  navReflow: "Readability",
  reflowTitle: "Readability check",
  reflowIntro:
    "Flag captions that break broadcast readability limits, then auto-split the offenders into compliant captions.",
  reflowLimits: "Limits",
  reflowReset: "Broadcast defaults",
  reflowMaxCps: "Reading speed",
  reflowMaxCharsPerLine: "Line length",
  reflowMaxLines: "Max lines",
  reflowMinDuration: "Min duration",
  reflowUnitCps: "CPS",
  reflowUnitChars: "chars",
  reflowUnitMs: "ms",
  reflowChecking: "Checking…",
  reflowClean: "Every caption is broadcast-compliant.",
  reflowIssueCount: "{n} caption(s) break a limit",
  reflowKindCps: "Reading speed",
  reflowKindLineLength: "Line length",
  reflowKindLineCount: "Line count",
  reflowKindMinDuration: "Too brief",
  reflowRepair: "Auto-fix {n}",
  reflowRepairing: "Fixing…",
  reflowRepaired: "Resolved {resolved} — {before} → {after} captions.",
  reflowResidual: "{n} couldn’t be auto-fixed (timing, not splitting).",
  navStyle: "Style",
  navExport: "Export",
  navSettings: "Settings",
  // ── Save state / autosave / close guard ─────────────────────────────────
  saveStateSaved: "Saved",
  saveStateUnsaved: "Unsaved changes",
  saveStateSaving: "Saving…",
  saveStateNoFile: "Not saved to a file yet",
  autosaveFailed: "Autosave failed: {message}",
  unsavedCloseTitle: "Unsaved changes",
  unsavedCloseBody:
    "This project has changes that have not been saved. Close anyway and lose them?",
  unsavedCloseConfirm: "Discard and close",
  unsavedCloseCancel: "Keep editing",
  projectOpen: "Open",
  projectSave: "Save",
  ...
  editorSelectToggle: "Select caption",
  editorSelectedCount: "{n} selected",
  editorSelectAll: "Select all",
  editorClearSelection: "Clear",
  editorBulkMerge: "Merge",
  editorBulkMergeHint: "Select 2 or more adjacent captions to merge",
  editorBulkDelete: "Delete",
  editorBulkSetSpeaker: "Speaker",
  editorBulkNoSpeaker: "No speaker",
  editorBulkSetSpeakerTitle: "Assign a speaker to the selected captions",
  editorShiftAll: "Shift whole project…",
  editorShiftAllPrompt:
    "Shift every caption by how many milliseconds? (negative = earlier)",
  tier1: "Confident",
  ...
  trackCloseGaps: "Close gaps on this track",
  inspectorSplit: "Split at playhead",
  inspectorDelete: "Delete (ripple)",
  mediaBinRemove: "Remove media",
  mediaBinMissing: "File missing",
  mediaBinRelink: "Find file…",
  relinkSearching: "Searching…",
  relinkPicking: "Not found automatically — choose it",
  relinkLinking: "Linking…",
  relinkFoundAutomatically: "Found automatically.",
  relinkSuccess: "Relinked.",
  relinkDurationWarning:
    "Relinked, but the new file's duration differs — clip timing may no longer line up.",
  relinkFailedGeneric: "Relink failed.",
  relinkWorking: "Working…",
  missingMediaBannerCount: "{n} file(s) are missing.",
  timelineClipMissingMedia: "Source file missing",
  trackMoveUp: "Move up",
  ...
  composeCodecLabel: "Codec",
  composeEncoderLabel: "Encoder",
  composeEncoderCpu: "CPU (most compatible)",
  composeEncoderVideoToolbox: "Hardware (Apple VideoToolbox)",
  composeEncoderNvenc: "Hardware (NVIDIA NVENC)",
  composeEncoderQuickSync: "Hardware (Intel Quick Sync)",
  composeProgressTitle: "Rendering composed video",
  composeCancel: "Cancel",
  composeCancelling: "Cancelling…",
  composeCancelled: "Render cancelled.",
  composeDone: "Saved to {path}",
  composeFailed: "Render failed: {error}",
  composeClose: "Close",

  // ── Highlight reel studio (batch social clips) ──────────────────────────
  navReel: "Highlight reel",
  reelTitle: "Highlight reel",
  reelIntro:
    "Turn one talk into a batch of vertical clips: propose a storyboard, review it, then burn every clip to every platform in one pass.",
  reelNeedsDesktop:
    "The highlight reel renders video with ffmpeg — open the desktop app to use it.",
  reelModelLabel: "Storyboard model",
  reelKeyHint:
    "With an Anthropic key Claude picks the clips. Without one they come from pauses in the talk.",
  reelGenerate: "Propose storyboard",
  reelRegenerate: "Refresh storyboard",
  reelGenerating: "Reading the transcript…",
  reelModeAi: "AI storyboard — Claude picked these clips.",
  reelModeHeuristic: "No API key — clips proposed from pauses in the talk.",
  reelModeAiFailed:
    "AI planner unavailable, using pauses in the talk instead: {error}",
  reelNoClips:
    "No clips proposed. The talk needs captions with words before a storyboard can be built.",
  reelClipsHeader: "{n} clip(s) in the storyboard",
  reelClipRemove: "Drop this clip",
  reelPlatformsHeader: "Platforms",
  reelPlatformsNone: "Pick at least one platform.",
  reelOutputFolder: "Output folder",
  reelNoFolder: "No folder chosen yet",
  reelPlanHeader: "{total} file(s) — {clips} clip(s) × {platforms} platform(s)",
  reelRenderAll: "Render all",
  reelProgressTitle: "Rendering the highlight reel",
  reelProgressCount: "{completed} of {total}",
  reelCancel: "Cancel",
  reelCancelling: "Stopping after this clip…",
  reelCancelled: "Render stopped. {n} file(s) finished first.",
  reelDone: "{n} file(s) written to {dir}",
  reelFailedCount: "{n} clip(s) failed.",
  reelClose: "Close",
  reelItemPending: "Waiting",
  reelItemRendering: "Rendering",
  reelItemDone: "Done",
  reelItemFailed: "Failed",

  // ── Preview render (proxy) ──────────────────────────────────────────────
  timelinePreviewRender: "Render preview",
  timelinePreviewRendering: "Rendering…",
  ...
  inspectorTrimIn: "In (ms)",
  inspectorTrimOut: "Out (ms)",
  inspectorTransitionHeader: "Transition (lead-in)",
  inspectorTransitionType: "Type",
  inspectorTransitionNone: "None",
  inspectorTransitionFade: "Fade",
  inspectorTransitionCrossfade: "Crossfade",
  inspectorTransitionDip: "Dip to black",
  inspectorTransitionDipWhite: "Dip to white",
  inspectorTransitionWipeLeft: "Wipe left",
  inspectorTransitionWipeRight: "Wipe right",
  inspectorTransitionSlideLeft: "Slide left",
  inspectorTransitionSlideRight: "Slide right",
  inspectorTransitionCircleOpen: "Circle open",
  inspectorDurationMs: "Duration (ms)",
  inspectorTransformHeader: "Transform (overlay / PiP)",
...
const no: Catalog = {
  ...
  paletteGroupTools: "Verktøy",
  paletteGroupPipeline: "Pipeline",
  paletteGroupProject: "Prosjekt",
  navSpeakers: "Talere",
  ...
  navReflow: "Lesbarhet",
  reflowTitle: "Lesbarhetssjekk",
  reflowIntro:
    "Marker undertekster som bryter kringkastingsgrenser for lesbarhet, og del opp synderne automatisk i kompatible undertekster.",
  reflowLimits: "Grenser",
  reflowReset: "Standard kringkasting",
  reflowMaxCps: "Lesehastighet",
  reflowMaxCharsPerLine: "Linjelengde",
  reflowMaxLines: "Maks linjer",
  reflowMinDuration: "Min varighet",
  reflowUnitCps: "TPS",
  reflowUnitChars: "tegn",
  reflowUnitMs: "ms",
  reflowChecking: "Sjekker…",
  reflowClean: "Alle undertekster følger kringkastingsgrensene.",
  reflowIssueCount: "{n} undertekst(er) bryter en grense",
  reflowKindCps: "Lesehastighet",
  reflowKindLineLength: "Linjelengde",
  reflowKindLineCount: "Antall linjer",
  reflowKindMinDuration: "For kort",
  reflowRepair: "Reparer {n}",
  reflowRepairing: "Reparerer…",
  reflowRepaired: "Løste {resolved} — {before} → {after} undertekster.",
  reflowResidual: "{n} kunne ikke repareres automatisk (timing, ikke deling).",
  navStyle: "Stil",
  navExport: "Eksport",
  navSettings: "Innstillinger",
  // ── Lagringsstatus / autolagring / lukkevakt ────────────────────────────
  saveStateSaved: "Lagret",
  saveStateUnsaved: "Ulagrede endringer",
  saveStateSaving: "Lagrer…",
  saveStateNoFile: "Ikke lagret til fil ennå",
  autosaveFailed: "Autolagring feilet: {message}",
  unsavedCloseTitle: "Ulagrede endringer",
  unsavedCloseBody:
    "Dette prosjektet har endringer som ikke er lagret. Lukke likevel og miste dem?",
  unsavedCloseConfirm: "Forkast og lukk",
  unsavedCloseCancel: "Fortsett å redigere",
  projectOpen: "Åpne",
  projectSave: "Lagre",
  projectSaveAs: "Lagre som…",
  ...
  editorSelectToggle: "Velg tekst",
  editorSelectedCount: "{n} valgt",
  editorSelectAll: "Velg alle",
  editorClearSelection: "Tøm",
  editorBulkMerge: "Slå sammen",
  editorBulkMergeHint:
    "Velg 2 eller flere tilstøtende tekster for å slå sammen",
  editorBulkDelete: "Slett",
  editorBulkSetSpeaker: "Taler",
  editorBulkNoSpeaker: "Ingen taler",
  editorBulkSetSpeakerTitle: "Tildel en taler til de valgte tekstene",
  editorShiftAll: "Forskyv hele prosjektet…",
  editorShiftAllPrompt:
    "Forskyv alle tekster med hvor mange millisekunder? (negativt = tidligere)",
  tier1: "Sikker",
  tier2: "Litt usikker",
  tier3: "Usikker",
  tier4: "Svært usikker",
  ...
  mediaBinImport: "Importer media",
  mediaBinImportError: "Import mislyktes: {error}",
  mediaBinEmpty:
    "Ingen media ennå. Importer et klipp for å plassere det på et spor.",
  mediaBinDragHint: "Dra et klipp til et spor for å plassere det.",
  mediaBinAddTrackHeader: "Legg til spor",
  mediaBinAddVideoTrack: "Videospor",
  mediaBinAddAudioTrack: "Lydspor",
  mediaBinAddOverlayTrack: "Overleggspor",
  trackEnabled: "Aktiver",
  trackMute: "Demp",
  trackVolume: "Volum",
  trackSolo: "Solo",
  trackLock: "Lås",
  trackRemove: "Fjern spor",
  trackCloseGaps: "Lukk hull på dette sporet",
  inspectorSplit: "Del ved spillehodet",
  inspectorDelete: "Slett (ripple)",
  mediaBinRemove: "Fjern media",
  mediaBinMissing: "Fil mangler",
  mediaBinRelink: "Finn filen…",
  relinkSearching: "Søker…",
  relinkPicking: "Fant den ikke automatisk — velg den",
  relinkLinking: "Kobler til…",
  relinkFoundAutomatically: "Funnet automatisk.",
  relinkSuccess: "Koblet til på nytt.",
  relinkDurationWarning:
    "Koblet til på nytt, men den nye filens varighet er annerledes — klipptidspunkter kan ha forskjøvet seg.",
  relinkFailedGeneric: "Ny tilkobling mislyktes.",
  relinkWorking: "Arbeider…",
  missingMediaBannerCount: "{n} fil(er) mangler.",
  timelineClipMissingMedia: "Kildefil mangler",
  trackMoveUp: "Flytt opp",
  trackMoveDown: "Flytt ned",
  ...
  composeCodecLabel: "Kodek",
  composeEncoderLabel: "Enkoder",
  composeEncoderCpu: "CPU (mest kompatibel)",
  composeEncoderVideoToolbox: "Maskinvare (Apple VideoToolbox)",
  composeEncoderNvenc: "Maskinvare (NVIDIA NVENC)",
  composeEncoderQuickSync: "Maskinvare (Intel Quick Sync)",
  composeProgressTitle: "Gjengir komponert video",
  composeCancel: "Avbryt",
  composeCancelling: "Avbryter…",
  composeCancelled: "Gjengivelse avbrutt.",
  composeDone: "Lagret til {path}",
  composeFailed: "Gjengivelse feilet: {error}",
  composeClose: "Lukk",

  // ── Høydepunkter (bunkevis av sosiale klipp) ────────────────────────────
  navReel: "Høydepunkter",
  reelTitle: "Høydepunkter",
  reelIntro:
    "Gjør én tale om til en bunke loddrette klipp: foreslå et storyboard, se gjennom det, og brenn hvert klipp til hver plattform i én omgang.",
  reelNeedsDesktop:
    "Høydepunkt-studioet gjengir video med ffmpeg — åpne skrivebordsappen for å bruke det.",
  reelModelLabel: "Modell for storyboard",
  reelKeyHint:
    "Med en Anthropic-nøkkel velger Claude klippene. Uten nøkkel kommer de fra pauser i talen.",
  reelGenerate: "Foreslå storyboard",
  reelRegenerate: "Oppdater storyboard",
  reelGenerating: "Leser transkripsjonen…",
  reelModeAi: "AI-storyboard — Claude valgte disse klippene.",
  reelModeHeuristic: "Ingen API-nøkkel — klipp foreslått fra pauser i talen.",
  reelModeAiFailed:
    "AI-planleggeren er utilgjengelig, bruker pauser i talen i stedet: {error}",
  reelNoClips:
    "Ingen klipp foreslått. Talen må ha undertekster med ord før et storyboard kan lages.",
  reelClipsHeader: "{n} klipp i storyboardet",
  reelClipRemove: "Fjern dette klippet",
  reelPlatformsHeader: "Plattformer",
  reelPlatformsNone: "Velg minst én plattform.",
  reelOutputFolder: "Utmappe",
  reelNoFolder: "Ingen mappe valgt ennå",
  reelPlanHeader: "{total} fil(er) — {clips} klipp × {platforms} plattform(er)",
  reelRenderAll: "Gjengi alle",
  reelProgressTitle: "Gjengir høydepunktene",
  reelProgressCount: "{completed} av {total}",
  reelCancel: "Avbryt",
  reelCancelling: "Stopper etter dette klippet…",
  reelCancelled: "Gjengivelsen ble stoppet. {n} fil(er) ble ferdige først.",
  reelDone: "{n} fil(er) skrevet til {dir}",
  reelFailedCount: "{n} klipp feilet.",
  reelClose: "Lukk",
  reelItemPending: "Venter",
  reelItemRendering: "Gjengir",
  reelItemDone: "Ferdig",
  reelItemFailed: "Feilet",

  // ── Preview render (proxy) ──────────────────────────────────────────────
  timelinePreviewRender: "Gjengi forhåndsvisning",
  timelinePreviewRendering: "Gjengir…",
  ...
  inspectorTrimHeader: "Trim",
  inspectorTrimIn: "Inn (ms)",
  inspectorTrimOut: "Ut (ms)",
  inspectorTransitionHeader: "Overgang (inn)",
  inspectorTransitionType: "Type",
  inspectorTransitionNone: "Ingen",
  inspectorTransitionFade: "Fade",
  inspectorTransitionCrossfade: "Kryssfade",
  inspectorTransitionDip: "Dipp til svart",
  inspectorTransitionDipWhite: "Dipp til hvitt",
  inspectorTransitionWipeLeft: "Visk mot venstre",
  inspectorTransitionWipeRight: "Visk mot høyre",
  inspectorTransitionSlideLeft: "Skyv mot venstre",
  inspectorTransitionSlideRight: "Skyv mot høyre",
  inspectorTransitionCircleOpen: "Sirkelåpning",
  inspectorDurationMs: "Varighet (ms)",
  inspectorTransformHeader: "Transform (overlegg / PiP)",
...
const sv: Catalog = {
  ...
  paletteGroupTools: "Verktyg",
  paletteGroupPipeline: "Pipeline",
  paletteGroupProject: "Projekt",
  navSpeakers: "Talare",
  ...
  navCleanup: "Städning",
  navReflow: "Läsbarhet",
  reflowTitle: "Läsbarhetskontroll",
  reflowIntro:
    "Flagga undertexter som bryter mot sändningsgränser för läsbarhet och dela automatiskt upp dem i kompatibla undertexter.",
  reflowLimits: "Gränser",
  reflowReset: "Standard för sändning",
  reflowMaxCps: "Läshastighet",
  reflowMaxCharsPerLine: "Radlängd",
  reflowMaxLines: "Max rader",
  reflowMinDuration: "Min varaktighet",
  reflowUnitCps: "TPS",
  reflowUnitChars: "tecken",
  reflowUnitMs: "ms",
  reflowChecking: "Kontrollerar…",
  reflowClean: "Alla undertexter följer sändningsgränserna.",
  reflowIssueCount: "{n} undertext(er) bryter mot en gräns",
  reflowKindCps: "Läshastighet",
  reflowKindLineLength: "Radlängd",
  reflowKindLineCount: "Antal rader",
  reflowKindMinDuration: "För kort",
  reflowRepair: "Åtgärda {n}",
  reflowRepairing: "Åtgärdar…",
  reflowRepaired: "Löste {resolved} — {before} → {after} undertexter.",
  reflowResidual: "{n} kunde inte åtgärdas automatiskt (timing, inte delning).",
  navStyle: "Stil",
  navExport: "Export",
  navSettings: "Inställningar",
  // ── Sparstatus / autospar / stängningsvakt ──────────────────────────────
  saveStateSaved: "Sparat",
  saveStateUnsaved: "Osparade ändringar",
  saveStateSaving: "Sparar…",
  saveStateNoFile: "Inte sparat till fil ännu",
  autosaveFailed: "Autosparning misslyckades: {message}",
  unsavedCloseTitle: "Osparade ändringar",
  unsavedCloseBody:
    "Projektet har ändringar som inte har sparats. Stänga ändå och förlora dem?",
  unsavedCloseConfirm: "Kasta och stäng",
  unsavedCloseCancel: "Fortsätt redigera",
  projectOpen: "Öppna",
  projectSave: "Spara",
  projectSaveAs: "Spara som…",
  ...
  editorSelectToggle: "Markera text",
  editorSelectedCount: "{n} markerade",
  editorSelectAll: "Markera alla",
  editorClearSelection: "Rensa",
  editorBulkMerge: "Slå ihop",
  editorBulkMergeHint:
    "Markera 2 eller fler intilliggande texter för att slå ihop",
  editorBulkDelete: "Ta bort",
  editorBulkSetSpeaker: "Talare",
  editorBulkNoSpeaker: "Ingen talare",
  editorBulkSetSpeakerTitle: "Tilldela en talare till de markerade texterna",
  editorShiftAll: "Förskjut hela projektet…",
  editorShiftAllPrompt:
    "Förskjut alla texter med hur många millisekunder? (negativt = tidigare)",
  tier1: "Säker",
  tier2: "Något osäker",
  tier3: "Osäker",
  tier4: "Mycket osäker",
  ...
  trackEnabled: "Aktivera",
  trackMute: "Tysta",
  trackVolume: "Volym",
  trackSolo: "Solo",
  trackLock: "Lås",
  trackRemove: "Ta bort spår",
  trackCloseGaps: "Stäng luckor på detta spår",
  inspectorSplit: "Dela vid spelhuvudet",
  inspectorDelete: "Ta bort (ripple)",
  mediaBinRemove: "Ta bort media",
  mediaBinMissing: "Fil saknas",
  mediaBinRelink: "Hitta filen…",
  relinkSearching: "Söker…",
  relinkPicking: "Hittades inte automatiskt — välj den",
  relinkLinking: "Länkar…",
  relinkFoundAutomatically: "Hittades automatiskt.",
  relinkSuccess: "Omlänkad.",
  relinkDurationWarning:
    "Omlänkad, men den nya filens längd skiljer sig — klipptiming kanske inte stämmer längre.",
  relinkFailedGeneric: "Omlänkning misslyckades.",
  relinkWorking: "Arbetar…",
  missingMediaBannerCount: "{n} fil(er) saknas.",
  timelineClipMissingMedia: "Källfilen saknas",
  ...
  exportComposeHeader: "Komponerad video",
  exportComposeAction: "Exportera komponerad video",
  exportComposeDesc: "Platta ut alla spår till en MP4 (ffmpeg).",
  composeCodecLabel: "Kodek",
  composeEncoderLabel: "Kodare",
  composeEncoderCpu: "CPU (mest kompatibel)",
  composeEncoderVideoToolbox: "Hårdvara (Apple VideoToolbox)",
  composeEncoderNvenc: "Hårdvara (NVIDIA NVENC)",
  composeEncoderQuickSync: "Hårdvara (Intel Quick Sync)",
  composeProgressTitle: "Renderar komponerad video",
  composeCancel: "Avbryt",
  composeCancelling: "Avbryter…",
  composeCancelled: "Rendering avbruten.",
  composeDone: "Sparad till {path}",
  composeFailed: "Rendering misslyckades: {error}",
  composeClose: "Stäng",

  // ── Höjdpunkter (buntvis av sociala klipp) ──────────────────────────────
  navReel: "Höjdpunkter",
  reelTitle: "Höjdpunkter",
  reelIntro:
    "Gör ett tal till en bunt stående klipp: föreslå ett storyboard, granska det och rendera varje klipp till varje plattform i en omgång.",
  reelNeedsDesktop:
    "Höjdpunktsstudion renderar video med ffmpeg — öppna skrivbordsappen för att använda den.",
  reelModelLabel: "Modell för storyboard",
  reelKeyHint:
    "Med en Anthropic-nyckel väljer Claude klippen. Utan nyckel kommer de från pauser i talet.",
  reelGenerate: "Föreslå storyboard",
  reelRegenerate: "Uppdatera storyboard",
  reelGenerating: "Läser transkriptionen…",
  reelModeAi: "AI-storyboard — Claude valde de här klippen.",
  reelModeHeuristic: "Ingen API-nyckel — klipp föreslagna från pauser i talet.",
  reelModeAiFailed:
    "AI-planeraren är otillgänglig, använder pauser i talet i stället: {error}",
  reelNoClips:
    "Inga klipp föreslagna. Talet behöver undertexter med ord innan ett storyboard kan byggas.",
  reelClipsHeader: "{n} klipp i storyboardet",
  reelClipRemove: "Ta bort klippet",
  reelPlatformsHeader: "Plattformar",
  reelPlatformsNone: "Välj minst en plattform.",
  reelOutputFolder: "Utmapp",
  reelNoFolder: "Ingen mapp vald ännu",
  reelPlanHeader: "{total} fil(er) — {clips} klipp × {platforms} plattform(ar)",
  reelRenderAll: "Rendera alla",
  reelProgressTitle: "Renderar höjdpunkterna",
  reelProgressCount: "{completed} av {total}",
  reelCancel: "Avbryt",
  reelCancelling: "Stoppar efter det här klippet…",
  reelCancelled: "Renderingen stoppades. {n} fil(er) hann bli klara.",
  reelDone: "{n} fil(er) skrivna till {dir}",
  reelFailedCount: "{n} klipp misslyckades.",
  reelClose: "Stäng",
  reelItemPending: "Väntar",
  reelItemRendering: "Renderar",
  reelItemDone: "Klar",
  reelItemFailed: "Misslyckades",
  timelinePreviewRender: "Rendera förhandsvisning",
  timelinePreviewRendering: "Renderar…",
  timelinePreviewDone: "Förhandsvisning renderad",
  timelinePreviewLive: "Tillbaka till live",
  navInspector: "Inspektör",
  inspectorTitle: "Klipp",
  inspectorTrimHeader: "Trimma",
  inspectorTrimIn: "In (ms)",
  inspectorTrimOut: "Ut (ms)",
  inspectorTransitionHeader: "Övergång (in)",
  inspectorTransitionType: "Typ",
  inspectorTransitionNone: "Ingen",
  inspectorTransitionFade: "Toning",
  inspectorTransitionCrossfade: "Korstoning",
  inspectorTransitionDip: "Dipp till svart",
  inspectorTransitionDipWhite: "Dipp till vitt",
  inspectorTransitionWipeLeft: "Svep åt vänster",
  inspectorTransitionWipeRight: "Svep åt höger",
  inspectorTransitionSlideLeft: "Skjut åt vänster",
  inspectorTransitionSlideRight: "Skjut åt höger",
  inspectorTransitionCircleOpen: "Cirkelöppning",
  inspectorDurationMs: "Längd (ms)",
  inspectorTransformHeader: "Transform (överlägg / PiP)",
  inspectorScale: "Skala",
  inspectorX: "X",
  inspectorY: "Y",
...
const da: Catalog = {
  ...
  navReflow: "Læsbarhed",
  reflowTitle: "Læsbarhedstjek",
  reflowIntro:
    "Markér undertekster, der bryder broadcast-grænser for læsbarhed, og opdel automatisk synderne i kompatible undertekster.",
  reflowLimits: "Grænser",
  reflowReset: "Broadcast-standard",
  reflowMaxCps: "Læsehastighed",
  reflowMaxCharsPerLine: "Linjelængde",
  reflowMaxLines: "Maks. linjer",
  reflowMinDuration: "Min. varighed",
  reflowUnitCps: "TPS",
  reflowUnitChars: "tegn",
  reflowUnitMs: "ms",
  reflowChecking: "Tjekker…",
  reflowClean: "Alle undertekster overholder broadcast-grænserne.",
  reflowIssueCount: "{n} undertekst(er) bryder en grænse",
  reflowKindCps: "Læsehastighed",
  reflowKindLineLength: "Linjelængde",
  reflowKindLineCount: "Antal linjer",
  reflowKindMinDuration: "For kort",
  reflowRepair: "Reparér {n}",
  reflowRepairing: "Reparerer…",
  reflowRepaired: "Løste {resolved} — {before} → {after} undertekster.",
  reflowResidual:
    "{n} kunne ikke repareres automatisk (timing, ikke opdeling).",
  navStyle: "Stil",
  navExport: "Eksport",
  navSettings: "Indstillinger",
  // ── Gemmestatus / autogem / lukkevagt ───────────────────────────────────
  saveStateSaved: "Gemt",
  saveStateUnsaved: "Ugemte ændringer",
  saveStateSaving: "Gemmer…",
  saveStateNoFile: "Ikke gemt til en fil endnu",
  autosaveFailed: "Autogem mislykkedes: {message}",
  unsavedCloseTitle: "Ugemte ændringer",
  unsavedCloseBody:
    "Projektet har ændringer, der ikke er gemt. Luk alligevel og mist dem?",
  unsavedCloseConfirm: "Kassér og luk",
  unsavedCloseCancel: "Bliv ved med at redigere",
  projectOpen: "Åbn",
  projectSave: "Gem",
  projectSaveAs: "Gem som…",
  ...
  editorSelectToggle: "Vælg tekst",
  editorSelectedCount: "{n} valgt",
  editorSelectAll: "Vælg alle",
  editorClearSelection: "Ryd",
  editorBulkMerge: "Flet sammen",
  editorBulkMergeHint: "Vælg 2 eller flere tilstødende tekster for at flette",
  editorBulkDelete: "Slet",
  editorBulkSetSpeaker: "Taler",
  editorBulkNoSpeaker: "Ingen taler",
  editorBulkSetSpeakerTitle: "Tildel en taler til de valgte tekster",
  editorShiftAll: "Forskyd hele projektet…",
  editorShiftAllPrompt:
    "Forskyd alle tekster med hvor mange millisekunder? (negativt = tidligere)",
  tier1: "Sikker",
  tier2: "Lidt usikker",
  tier3: "Usikker",
  tier4: "Meget usikker",
  ...
  trackEnabled: "Aktivér",
  trackMute: "Dæmp",
  trackVolume: "Lydstyrke",
  trackSolo: "Solo",
  trackLock: "Lås",
  trackRemove: "Fjern spor",
  trackCloseGaps: "Luk huller på dette spor",
  inspectorSplit: "Del ved afspilningshovedet",
  inspectorDelete: "Slet (ripple)",
  mediaBinRemove: "Fjern medie",
  mediaBinMissing: "Fil mangler",
  mediaBinRelink: "Find filen…",
  relinkSearching: "Søger…",
  relinkPicking: "Blev ikke fundet automatisk — vælg den",
  relinkLinking: "Kobler til…",
  relinkFoundAutomatically: "Fundet automatisk.",
  relinkSuccess: "Gentilsluttet.",
  relinkDurationWarning:
    "Gentilsluttet, men den nye fils varighed er anderledes — klip-timing stemmer måske ikke længere.",
  relinkFailedGeneric: "Gentilslutning mislykkedes.",
  relinkWorking: "Arbejder…",
  missingMediaBannerCount: "{n} fil(er) mangler.",
  timelineClipMissingMedia: "Kildefil mangler",
  trackMoveUp: "Flyt op",
  ...
  exportComposeHeader: "Komponeret video",
  exportComposeAction: "Eksportér komponeret video",
  exportComposeDesc: "Flad alle spor ud til én MP4 (ffmpeg).",
  composeCodecLabel: "Codec",
  composeEncoderLabel: "Encoder",
  composeEncoderCpu: "CPU (mest kompatibel)",
  composeEncoderVideoToolbox: "Hardware (Apple VideoToolbox)",
  composeEncoderNvenc: "Hardware (NVIDIA NVENC)",
  composeEncoderQuickSync: "Hardware (Intel Quick Sync)",
  composeProgressTitle: "Renderer komponeret video",
  composeCancel: "Annullér",
  composeCancelling: "Annullerer…",
  composeCancelled: "Rendering annulleret.",
  composeDone: "Gemt til {path}",
  composeFailed: "Rendering mislykkedes: {error}",
  composeClose: "Luk",

  // ── Højdepunkter (bunkevis af sociale klip) ─────────────────────────────
  navReel: "Højdepunkter",
  reelTitle: "Højdepunkter",
  reelIntro:
    "Lav én tale om til en stak lodrette klip: foreslå et storyboard, gennemgå det, og rendér hvert klip til hver platform i én omgang.",
  reelNeedsDesktop:
    "Højdepunktsstudiet renderer video med ffmpeg — åbn skrivebordsappen for at bruge det.",
  reelModelLabel: "Model til storyboard",
  reelKeyHint:
    "Med en Anthropic-nøgle vælger Claude klippene. Uden nøgle kommer de fra pauser i talen.",
  reelGenerate: "Foreslå storyboard",
  reelRegenerate: "Opdatér storyboard",
  reelGenerating: "Læser transskriptionen…",
  reelModeAi: "AI-storyboard — Claude valgte disse klip.",
  reelModeHeuristic: "Ingen API-nøgle — klip foreslået ud fra pauser i talen.",
  reelModeAiFailed:
    "AI-planlæggeren er utilgængelig, bruger pauser i talen i stedet: {error}",
  reelNoClips:
    "Ingen klip foreslået. Talen skal have undertekster med ord, før et storyboard kan bygges.",
  reelClipsHeader: "{n} klip i storyboardet",
  reelClipRemove: "Fjern dette klip",
  reelPlatformsHeader: "Platforme",
  reelPlatformsNone: "Vælg mindst én platform.",
  reelOutputFolder: "Outputmappe",
  reelNoFolder: "Ingen mappe valgt endnu",
  reelPlanHeader: "{total} fil(er) — {clips} klip × {platforms} platform(e)",
  reelRenderAll: "Rendér alle",
  reelProgressTitle: "Renderer højdepunkterne",
  reelProgressCount: "{completed} af {total}",
  reelCancel: "Annullér",
  reelCancelling: "Stopper efter dette klip…",
  reelCancelled:
    "Renderingen blev stoppet. {n} fil(er) nåede at blive færdige.",
  reelDone: "{n} fil(er) skrevet til {dir}",
  reelFailedCount: "{n} klip fejlede.",
  reelClose: "Luk",
  reelItemPending: "Venter",
  reelItemRendering: "Renderer",
  reelItemDone: "Færdig",
  reelItemFailed: "Fejlede",
  timelinePreviewRender: "Rendér forhåndsvisning",
  timelinePreviewRendering: "Renderer…",
  timelinePreviewDone: "Forhåndsvisning renderet",
  timelinePreviewLive: "Tilbage til live",
  navInspector: "Inspektør",
  inspectorTitle: "Klip",
  inspectorTrimHeader: "Trim",
  inspectorTrimIn: "Ind (ms)",
  inspectorTrimOut: "Ud (ms)",
  inspectorTransitionHeader: "Overgang (ind)",
  inspectorTransitionType: "Type",
  inspectorTransitionNone: "Ingen",
  inspectorTransitionFade: "Fade",
  inspectorTransitionCrossfade: "Krydsfade",
  inspectorTransitionDip: "Dip til sort",
  inspectorTransitionDipWhite: "Dip til hvid",
  inspectorTransitionWipeLeft: "Visk mod venstre",
  inspectorTransitionWipeRight: "Visk mod højre",
  inspectorTransitionSlideLeft: "Skub mod venstre",
  inspectorTransitionSlideRight: "Skub mod højre",
  inspectorTransitionCircleOpen: "Cirkelåbning",
  inspectorDurationMs: "Varighed (ms)",
  inspectorTransformHeader: "Transform (overlay / PiP)",
  inspectorScale: "Skala",
  inspectorX: "X",
  inspectorY: "Y",
...
const de: Catalog = {
  ...
  navReflow: "Lesbarkeit",
  reflowTitle: "Lesbarkeitsprüfung",
  reflowIntro:
    "Untertitel markieren, die Broadcast-Lesbarkeitsgrenzen verletzen, und die Verstöße automatisch in konforme Untertitel aufteilen.",
  reflowLimits: "Grenzwerte",
  reflowReset: "Broadcast-Standard",
  reflowMaxCps: "Lesegeschwindigkeit",
  reflowMaxCharsPerLine: "Zeilenlänge",
  reflowMaxLines: "Max. Zeilen",
  reflowMinDuration: "Mindestdauer",
  reflowUnitCps: "ZpS",
  reflowUnitChars: "Zeichen",
  reflowUnitMs: "ms",
  reflowChecking: "Prüfe…",
  reflowClean: "Alle Untertitel entsprechen den Broadcast-Grenzwerten.",
  reflowIssueCount: "{n} Untertitel verletzen ein Limit",
  reflowKindCps: "Lesegeschwindigkeit",
  reflowKindLineLength: "Zeilenlänge",
  reflowKindLineCount: "Zeilenanzahl",
  reflowKindMinDuration: "Zu kurz",
  reflowRepair: "{n} beheben",
  reflowRepairing: "Behebe…",
  reflowRepaired: "{resolved} behoben — {before} → {after} Untertitel.",
  reflowResidual:
    "{n} konnten nicht automatisch behoben werden (Timing, nicht Aufteilung).",
  navStyle: "Stil",
  navExport: "Export",
  navSettings: "Einstellungen",
  // ── Speicherstatus / Autospeichern / Schließschutz ──────────────────────
  saveStateSaved: "Gespeichert",
  saveStateUnsaved: "Nicht gespeicherte Änderungen",
  saveStateSaving: "Speichern…",
  saveStateNoFile: "Noch nicht in einer Datei gespeichert",
  autosaveFailed: "Automatisches Speichern fehlgeschlagen: {message}",
  unsavedCloseTitle: "Nicht gespeicherte Änderungen",
  unsavedCloseBody:
    "Dieses Projekt hat ungespeicherte Änderungen. Trotzdem schließen und verwerfen?",
  unsavedCloseConfirm: "Verwerfen und schließen",
  unsavedCloseCancel: "Weiter bearbeiten",
  projectOpen: "Öffnen",
  projectSave: "Speichern",
  projectSaveAs: "Speichern unter…",
  ...
  editorSelectToggle: "Untertitel auswählen",
  editorSelectedCount: "{n} ausgewählt",
  editorSelectAll: "Alle auswählen",
  editorClearSelection: "Leeren",
  editorBulkMerge: "Zusammenführen",
  editorBulkMergeHint:
    "Wählen Sie 2 oder mehr benachbarte Untertitel zum Zusammenführen",
  editorBulkDelete: "Löschen",
  editorBulkSetSpeaker: "Sprecher",
  editorBulkNoSpeaker: "Kein Sprecher",
  editorBulkSetSpeakerTitle:
    "Den ausgewählten Untertiteln einen Sprecher zuweisen",
  editorShiftAll: "Gesamtes Projekt verschieben…",
  editorShiftAllPrompt:
    "Alle Untertitel um wie viele Millisekunden verschieben? (negativ = früher)",
  tier1: "Sicher",
  ...
  trackEnabled: "Aktivieren",
  trackMute: "Stumm",
  trackVolume: "Lautstärke",
  trackSolo: "Solo",
  trackLock: "Sperren",
  trackRemove: "Spur entfernen",
  trackCloseGaps: "Lücken auf dieser Spur schließen",
  inspectorSplit: "Am Abspielkopf teilen",
  inspectorDelete: "Löschen (Ripple)",
  mediaBinRemove: "Medium entfernen",
  mediaBinMissing: "Datei fehlt",
  mediaBinRelink: "Datei suchen…",
  relinkSearching: "Suche…",
  relinkPicking: "Nicht automatisch gefunden — auswählen",
  relinkLinking: "Verknüpfe…",
  relinkFoundAutomatically: "Automatisch gefunden.",
  relinkSuccess: "Neu verknüpft.",
  relinkDurationWarning:
    "Neu verknüpft, aber die Dauer der neuen Datei weicht ab — die Clip-Zeitleiste stimmt möglicherweise nicht mehr.",
  relinkFailedGeneric: "Neuverknüpfung fehlgeschlagen.",
  relinkWorking: "Wird bearbeitet…",
  missingMediaBannerCount: "{n} Datei(en) fehlen.",
  timelineClipMissingMedia: "Quelldatei fehlt",
  ...
  exportComposeHeader: "Komponiertes Video",
  exportComposeAction: "Komponiertes Video exportieren",
  exportComposeDesc: "Alle Spuren zu einer MP4 zusammenführen (ffmpeg).",
  composeCodecLabel: "Codec",
  composeEncoderLabel: "Encoder",
  composeEncoderCpu: "CPU (am kompatibelsten)",
  composeEncoderVideoToolbox: "Hardware (Apple VideoToolbox)",
  composeEncoderNvenc: "Hardware (NVIDIA NVENC)",
  composeEncoderQuickSync: "Hardware (Intel Quick Sync)",
  composeProgressTitle: "Komponiertes Video wird gerendert",
  composeCancel: "Abbrechen",
  composeCancelling: "Wird abgebrochen…",
  composeCancelled: "Rendern abgebrochen.",
  composeDone: "Gespeichert unter {path}",
  composeFailed: "Rendern fehlgeschlagen: {error}",
  composeClose: "Schließen",

  // ── Highlight-Reel (Social-Clips im Stapel) ─────────────────────────────
  navReel: "Highlight-Reel",
  reelTitle: "Highlight-Reel",
  reelIntro:
    "Aus einer Predigt ein Bündel Hochformat-Clips: Storyboard vorschlagen, prüfen und jeden Clip in einem Durchgang für jede Plattform rendern.",
  reelNeedsDesktop:
    "Das Highlight-Reel rendert Video mit ffmpeg — dafür die Desktop-App öffnen.",
  reelModelLabel: "Modell für das Storyboard",
  reelKeyHint:
    "Mit einem Anthropic-Schlüssel wählt Claude die Clips. Ohne Schlüssel entstehen sie aus Pausen im Vortrag.",
  reelGenerate: "Storyboard vorschlagen",
  reelRegenerate: "Storyboard aktualisieren",
  reelGenerating: "Transkript wird gelesen…",
  reelModeAi: "KI-Storyboard — Claude hat diese Clips gewählt.",
  reelModeHeuristic:
    "Kein API-Schlüssel — Clips aus Pausen im Vortrag vorgeschlagen.",
  reelModeAiFailed:
    "KI-Planer nicht verfügbar, stattdessen Pausen im Vortrag: {error}",
  reelNoClips:
    "Keine Clips vorgeschlagen. Der Vortrag braucht Untertitel mit Wörtern, bevor ein Storyboard entstehen kann.",
  reelClipsHeader: "{n} Clip(s) im Storyboard",
  reelClipRemove: "Diesen Clip verwerfen",
  reelPlatformsHeader: "Plattformen",
  reelPlatformsNone: "Mindestens eine Plattform wählen.",
  reelOutputFolder: "Ausgabeordner",
  reelNoFolder: "Noch kein Ordner gewählt",
  reelPlanHeader:
    "{total} Datei(en) — {clips} Clip(s) × {platforms} Plattform(en)",
  reelRenderAll: "Alle rendern",
  reelProgressTitle: "Highlight-Reel wird gerendert",
  reelProgressCount: "{completed} von {total}",
  reelCancel: "Abbrechen",
  reelCancelling: "Stoppt nach diesem Clip…",
  reelCancelled: "Rendern gestoppt. {n} Datei(en) wurden vorher fertig.",
  reelDone: "{n} Datei(en) nach {dir} geschrieben",
  reelFailedCount: "{n} Clip(s) fehlgeschlagen.",
  reelClose: "Schließen",
  reelItemPending: "Wartet",
  reelItemRendering: "Rendert",
  reelItemDone: "Fertig",
  reelItemFailed: "Fehlgeschlagen",
  timelinePreviewRender: "Vorschau rendern",
  timelinePreviewRendering: "Wird gerendert…",
  timelinePreviewDone: "Vorschau gerendert",
  timelinePreviewLive: "Zurück zu Live",
  navInspector: "Inspektor",
  inspectorTitle: "Clip",
  inspectorTrimHeader: "Trimmen",
  inspectorTrimIn: "Anfang (ms)",
  inspectorTrimOut: "Ende (ms)",
  inspectorTransitionHeader: "Übergang (Anfang)",
  inspectorTransitionType: "Typ",
  inspectorTransitionNone: "Keiner",
  inspectorTransitionFade: "Blende",
  inspectorTransitionCrossfade: "Überblendung",
  inspectorTransitionDip: "Abblende zu Schwarz",
  inspectorTransitionDipWhite: "Abblende zu Weiß",
  inspectorTransitionWipeLeft: "Wischen nach links",
  inspectorTransitionWipeRight: "Wischen nach rechts",
  inspectorTransitionSlideLeft: "Schieben nach links",
  inspectorTransitionSlideRight: "Schieben nach rechts",
  inspectorTransitionCircleOpen: "Kreisblende auf",
  inspectorDurationMs: "Dauer (ms)",
  inspectorTransformHeader: "Transformation (Overlay / PiP)",
...
const fr: Catalog = {
  ...
  paletteGroupTools: "Outils",
  paletteGroupPipeline: "Pipeline",
  paletteGroupProject: "Projet",
  ...
  navReflow: "Lisibilité",
  reflowTitle: "Contrôle de lisibilité",
  reflowIntro:
    "Signalez les sous-titres qui dépassent les limites de lisibilité de diffusion, puis divisez automatiquement les fautifs en sous-titres conformes.",
  reflowLimits: "Limites",
  reflowReset: "Valeurs de diffusion",
  reflowMaxCps: "Vitesse de lecture",
  reflowMaxCharsPerLine: "Longueur de ligne",
  reflowMaxLines: "Lignes max",
  reflowMinDuration: "Durée min",
  reflowUnitCps: "CPS",
  reflowUnitChars: "car.",
  reflowUnitMs: "ms",
  reflowChecking: "Vérification…",
  reflowClean: "Tous les sous-titres respectent les limites de diffusion.",
  reflowIssueCount: "{n} sous-titre(s) dépassent une limite",
  reflowKindCps: "Vitesse de lecture",
  reflowKindLineLength: "Longueur de ligne",
  reflowKindLineCount: "Nombre de lignes",
  reflowKindMinDuration: "Trop bref",
  reflowRepair: "Corriger {n}",
  reflowRepairing: "Correction…",
  reflowRepaired: "{resolved} corrigé(s) — {before} → {after} sous-titres.",
  reflowResidual:
    "{n} n’ont pas pu être corrigés automatiquement (minutage, pas découpage).",
  navStyle: "Style",
  navExport: "Export",
  navSettings: "Paramètres",
  // ── État d’enregistrement / sauvegarde auto / garde de fermeture ────────
  saveStateSaved: "Enregistré",
  saveStateUnsaved: "Modifications non enregistrées",
  saveStateSaving: "Enregistrement…",
  saveStateNoFile: "Pas encore enregistré dans un fichier",
  autosaveFailed: "Échec de la sauvegarde automatique : {message}",
  unsavedCloseTitle: "Modifications non enregistrées",
  unsavedCloseBody:
    "Ce projet contient des modifications non enregistrées. Fermer quand même et les perdre ?",
  unsavedCloseConfirm: "Abandonner et fermer",
  unsavedCloseCancel: "Continuer l’édition",
  projectOpen: "Ouvrir",
  projectSave: "Enregistrer",
  projectSaveAs: "Enregistrer sous…",
  ...
  editorSelectToggle: "Sélectionner le sous-titre",
  editorSelectedCount: "{n} sélectionné(s)",
  editorSelectAll: "Tout sélectionner",
  editorClearSelection: "Effacer",
  editorBulkMerge: "Fusionner",
  editorBulkMergeHint:
    "Sélectionnez 2 sous-titres adjacents ou plus pour fusionner",
  editorBulkDelete: "Supprimer",
  editorBulkSetSpeaker: "Intervenant",
  editorBulkNoSpeaker: "Aucun intervenant",
  editorBulkSetSpeakerTitle:
    "Attribuer un intervenant aux sous-titres sélectionnés",
  editorShiftAll: "Décaler tout le projet…",
  editorShiftAllPrompt:
    "Décaler tous les sous-titres de combien de millisecondes ? (négatif = plus tôt)",
  tier1: "Sûr",
  ...
  trackEnabled: "Activer",
  trackMute: "Muet",
  trackVolume: "Volume",
  trackSolo: "Solo",
  trackLock: "Verrouiller",
  trackRemove: "Supprimer la piste",
  trackCloseGaps: "Fermer les trous sur cette piste",
  inspectorSplit: "Scinder à la tête de lecture",
  inspectorDelete: "Supprimer (ripple)",
  mediaBinRemove: "Supprimer le média",
  mediaBinMissing: "Fichier manquant",
  mediaBinRelink: "Retrouver le fichier…",
  relinkSearching: "Recherche…",
  relinkPicking: "Introuvable automatiquement — choisissez-le",
  relinkLinking: "Liaison…",
  relinkFoundAutomatically: "Trouvé automatiquement.",
  relinkSuccess: "Relié.",
  relinkDurationWarning:
    "Relié, mais la durée du nouveau fichier diffère — le minutage des clips peut ne plus correspondre.",
  relinkFailedGeneric: "Échec de la reliaison.",
  relinkWorking: "En cours…",
  missingMediaBannerCount: "{n} fichier(s) manquant(s).",
  timelineClipMissingMedia: "Fichier source manquant",
  trackMoveUp: "Monter",
  ...
  exportComposeHeader: "Vidéo composée",
  exportComposeAction: "Exporter la vidéo composée",
  exportComposeDesc: "Aplatir toutes les pistes en un seul MP4 (ffmpeg).",
  composeCodecLabel: "Codec",
  composeEncoderLabel: "Encodeur",
  composeEncoderCpu: "CPU (le plus compatible)",
  composeEncoderVideoToolbox: "Matériel (Apple VideoToolbox)",
  composeEncoderNvenc: "Matériel (NVIDIA NVENC)",
  composeEncoderQuickSync: "Matériel (Intel Quick Sync)",
  composeProgressTitle: "Rendu de la vidéo composée",
  composeCancel: "Annuler",
  composeCancelling: "Annulation…",
  composeCancelled: "Rendu annulé.",
  composeDone: "Enregistré dans {path}",
  composeFailed: "Échec du rendu : {error}",
  composeClose: "Fermer",

  // ── Extraits (clips sociaux par lots) ───────────────────────────────────
  navReel: "Extraits",
  reelTitle: "Extraits",
  reelIntro:
    "Transformez une prédication en une série de clips verticaux : proposez un storyboard, relisez-le, puis rendez chaque clip pour chaque plateforme en une seule passe.",
  reelNeedsDesktop:
    "Le studio d’extraits encode la vidéo avec ffmpeg — ouvrez l’application de bureau pour l’utiliser.",
  reelModelLabel: "Modèle du storyboard",
  reelKeyHint:
    "Avec une clé Anthropic, Claude choisit les clips. Sans clé, ils viennent des pauses du discours.",
  reelGenerate: "Proposer un storyboard",
  reelRegenerate: "Actualiser le storyboard",
  reelGenerating: "Lecture de la transcription…",
  reelModeAi: "Storyboard IA — Claude a choisi ces clips.",
  reelModeHeuristic:
    "Aucune clé API — clips proposés à partir des pauses du discours.",
  reelModeAiFailed:
    "Planificateur IA indisponible, utilisation des pauses du discours : {error}",
  reelNoClips:
    "Aucun clip proposé. Le discours doit avoir des sous-titres avec des mots avant de construire un storyboard.",
  reelClipsHeader: "{n} clip(s) dans le storyboard",
  reelClipRemove: "Retirer ce clip",
  reelPlatformsHeader: "Plateformes",
  reelPlatformsNone: "Choisissez au moins une plateforme.",
  reelOutputFolder: "Dossier de sortie",
  reelNoFolder: "Aucun dossier choisi",
  reelPlanHeader:
    "{total} fichier(s) — {clips} clip(s) × {platforms} plateforme(s)",
  reelRenderAll: "Tout rendre",
  reelProgressTitle: "Rendu des extraits",
  reelProgressCount: "{completed} sur {total}",
  reelCancel: "Annuler",
  reelCancelling: "Arrêt après ce clip…",
  reelCancelled: "Rendu arrêté. {n} fichier(s) terminé(s) avant.",
  reelDone: "{n} fichier(s) écrit(s) dans {dir}",
  reelFailedCount: "{n} clip(s) en échec.",
  reelClose: "Fermer",
  reelItemPending: "En attente",
  reelItemRendering: "Rendu",
  reelItemDone: "Terminé",
  reelItemFailed: "Échec",
  timelinePreviewRender: "Rendre l’aperçu",
  timelinePreviewRendering: "Rendu…",
  timelinePreviewDone: "Aperçu rendu",
  timelinePreviewLive: "Retour au direct",
  navInspector: "Inspecteur",
  inspectorTitle: "Clip",
  inspectorTrimHeader: "Rogner",
  inspectorTrimIn: "Entrée (ms)",
  inspectorTrimOut: "Sortie (ms)",
  inspectorTransitionHeader: "Transition (entrée)",
  inspectorTransitionType: "Type",
  inspectorTransitionNone: "Aucune",
  inspectorTransitionFade: "Fondu",
  inspectorTransitionCrossfade: "Fondu enchaîné",
  inspectorTransitionDip: "Fondu au noir",
  inspectorTransitionDipWhite: "Fondu au blanc",
  inspectorTransitionWipeLeft: "Volet vers la gauche",
  inspectorTransitionWipeRight: "Volet vers la droite",
  inspectorTransitionSlideLeft: "Glissement vers la gauche",
  inspectorTransitionSlideRight: "Glissement vers la droite",
  inspectorTransitionCircleOpen: "Ouverture en cercle",
  inspectorDurationMs: "Durée (ms)",
  inspectorTransformHeader: "Transformation (incrustation / PiP)",
...
const pl: Catalog = {
  ...
  navReflow: "Czytelność",
  reflowTitle: "Kontrola czytelności",
  reflowIntro:
    "Oznacz napisy przekraczające limity czytelności dla nadawania, a następnie automatycznie podziel je na zgodne napisy.",
  reflowLimits: "Limity",
  reflowReset: "Domyślne nadawania",
  reflowMaxCps: "Szybkość czytania",
  reflowMaxCharsPerLine: "Długość wiersza",
  reflowMaxLines: "Maks. wierszy",
  reflowMinDuration: "Min. czas",
  reflowUnitCps: "ZNS",
  reflowUnitChars: "znaki",
  reflowUnitMs: "ms",
  reflowChecking: "Sprawdzanie…",
  reflowClean: "Wszystkie napisy spełniają limity nadawania.",
  reflowIssueCount: "{n} napis(ów) przekracza limit",
  reflowKindCps: "Szybkość czytania",
  reflowKindLineLength: "Długość wiersza",
  reflowKindLineCount: "Liczba wierszy",
  reflowKindMinDuration: "Za krótki",
  reflowRepair: "Napraw {n}",
  reflowRepairing: "Naprawianie…",
  reflowRepaired: "Naprawiono {resolved} — {before} → {after} napisów.",
  reflowResidual:
    "{n} nie udało się naprawić automatycznie (czas, nie podział).",
  navStyle: "Styl",
  navExport: "Eksport",
  navSettings: "Ustawienia",
  // ── Stan zapisu / autozapis / strażnik zamknięcia ───────────────────────
  saveStateSaved: "Zapisano",
  saveStateUnsaved: "Niezapisane zmiany",
  saveStateSaving: "Zapisywanie…",
  saveStateNoFile: "Jeszcze nie zapisano do pliku",
  autosaveFailed: "Autozapis nie powiódł się: {message}",
  unsavedCloseTitle: "Niezapisane zmiany",
  unsavedCloseBody:
    "Ten projekt ma niezapisane zmiany. Zamknąć mimo to i je utracić?",
  unsavedCloseConfirm: "Odrzuć i zamknij",
  unsavedCloseCancel: "Kontynuuj edycję",
  projectOpen: "Otwórz",
  projectSave: "Zapisz",
  projectSaveAs: "Zapisz jako…",
  ...
  editorSelectToggle: "Zaznacz napis",
  editorSelectedCount: "zaznaczono {n}",
  editorSelectAll: "Zaznacz wszystkie",
  editorClearSelection: "Wyczyść",
  editorBulkMerge: "Scal",
  editorBulkMergeHint: "Zaznacz 2 lub więcej sąsiadujących napisów, aby scalić",
  editorBulkDelete: "Usuń",
  editorBulkSetSpeaker: "Mówca",
  editorBulkNoSpeaker: "Brak mówcy",
  editorBulkSetSpeakerTitle: "Przypisz mówcę do zaznaczonych napisów",
  editorShiftAll: "Przesuń cały projekt…",
  editorShiftAllPrompt:
    "Przesunąć wszystkie napisy o ile milisekund? (ujemne = wcześniej)",
  tier1: "Pewne",
  ...
  trackCloseGaps: "Zamknij luki na tej ścieżce",
  inspectorSplit: "Podziel w miejscu głowicy",
  inspectorDelete: "Usuń (ripple)",
  mediaBinRemove: "Usuń multimedia",
  mediaBinMissing: "Brak pliku",
  mediaBinRelink: "Znajdź plik…",
  relinkSearching: "Szukanie…",
  relinkPicking: "Nie znaleziono automatycznie — wybierz go",
  relinkLinking: "Łączenie…",
  relinkFoundAutomatically: "Znaleziono automatycznie.",
  relinkSuccess: "Połączono ponownie.",
  relinkDurationWarning:
    "Połączono ponownie, ale czas trwania nowego pliku jest inny — synchronizacja klipu może się nie zgadzać.",
  relinkFailedGeneric: "Ponowne połączenie nie powiodło się.",
  relinkWorking: "Przetwarzanie…",
  missingMediaBannerCount: "{n} plik(ów) brakuje.",
  timelineClipMissingMedia: "Brak pliku źródłowego",
  ...
  exportComposeHeader: "Wideo złożone",
  exportComposeAction: "Eksportuj wideo złożone",
  exportComposeDesc: "Spłaszcz wszystkie ścieżki do jednego MP4 (ffmpeg).",
  composeCodecLabel: "Kodek",
  composeEncoderLabel: "Koder",
  composeEncoderCpu: "CPU (najbardziej kompatybilny)",
  composeEncoderVideoToolbox: "Sprzęt (Apple VideoToolbox)",
  composeEncoderNvenc: "Sprzęt (NVIDIA NVENC)",
  composeEncoderQuickSync: "Sprzęt (Intel Quick Sync)",
  composeProgressTitle: "Renderowanie wideo złożonego",
  composeCancel: "Anuluj",
  composeCancelling: "Anulowanie…",
  composeCancelled: "Renderowanie anulowane.",
  composeDone: "Zapisano do {path}",
  composeFailed: "Renderowanie nie powiodło się: {error}",
  composeClose: "Zamknij",

  // ── Najlepsze fragmenty (klipy społecznościowe wsadowo) ─────────────────
  navReel: "Najlepsze fragmenty",
  reelTitle: "Najlepsze fragmenty",
  reelIntro:
    "Zamień jedno kazanie w zestaw pionowych klipów: zaproponuj storyboard, przejrzyj go i wyrenderuj każdy klip na każdą platformę za jednym razem.",
  reelNeedsDesktop:
    "Studio fragmentów renderuje wideo przez ffmpeg — otwórz aplikację desktopową, aby z niego korzystać.",
  reelModelLabel: "Model storyboardu",
  reelKeyHint:
    "Z kluczem Anthropic klipy wybiera Claude. Bez klucza powstają z pauz w mowie.",
  reelGenerate: "Zaproponuj storyboard",
  reelRegenerate: "Odśwież storyboard",
  reelGenerating: "Czytanie transkrypcji…",
  reelModeAi: "Storyboard AI — te klipy wybrał Claude.",
  reelModeHeuristic:
    "Brak klucza API — klipy zaproponowane na podstawie pauz w mowie.",
  reelModeAiFailed: "Planer AI niedostępny, używam pauz w mowie: {error}",
  reelNoClips:
    "Nie zaproponowano klipów. Kazanie musi mieć napisy ze słowami, zanim powstanie storyboard.",
  reelClipsHeader: "Klipy w storyboardzie: {n}",
  reelClipRemove: "Usuń ten klip",
  reelPlatformsHeader: "Platformy",
  reelPlatformsNone: "Wybierz co najmniej jedną platformę.",
  reelOutputFolder: "Folder wyjściowy",
  reelNoFolder: "Nie wybrano jeszcze folderu",
  reelPlanHeader: "Pliki: {total} — klipy: {clips} × platformy: {platforms}",
  reelRenderAll: "Renderuj wszystko",
  reelProgressTitle: "Renderowanie fragmentów",
  reelProgressCount: "{completed} z {total}",
  reelCancel: "Anuluj",
  reelCancelling: "Zatrzymanie po tym klipie…",
  reelCancelled: "Renderowanie zatrzymane. Ukończone pliki: {n}.",
  reelDone: "Zapisano pliki ({n}) do {dir}",
  reelFailedCount: "Nieudane klipy: {n}.",
  reelClose: "Zamknij",
  reelItemPending: "Czeka",
  reelItemRendering: "Renderuje",
  reelItemDone: "Gotowe",
  reelItemFailed: "Błąd",
  timelinePreviewRender: "Renderuj podgląd",
  timelinePreviewRendering: "Renderowanie…",
  timelinePreviewDone: "Podgląd wyrenderowany",
  timelinePreviewLive: "Powrót do live",
  navInspector: "Inspektor",
  inspectorTitle: "Klip",
  inspectorTrimHeader: "Przytnij",
  inspectorTrimIn: "Wejście (ms)",
  inspectorTrimOut: "Wyjście (ms)",
  inspectorTransitionHeader: "Przejście (wejście)",
  inspectorTransitionType: "Typ",
  inspectorTransitionNone: "Brak",
  inspectorTransitionFade: "Zanikanie",
  inspectorTransitionCrossfade: "Przenikanie",
  inspectorTransitionDip: "Zaciemnienie",
  inspectorTransitionDipWhite: "Rozjaśnienie do bieli",
  inspectorTransitionWipeLeft: "Przetarcie w lewo",
  inspectorTransitionWipeRight: "Przetarcie w prawo",
  inspectorTransitionSlideLeft: "Przesunięcie w lewo",
  inspectorTransitionSlideRight: "Przesunięcie w prawo",
  inspectorTransitionCircleOpen: "Otwarcie kołowe",
  inspectorDurationMs: "Czas trwania (ms)",
  inspectorTransformHeader: "Transformacja (nakładka / PiP)",
  inspectorScale: "Skala",
  inspectorX: "X",
  inspectorY: "Y",
